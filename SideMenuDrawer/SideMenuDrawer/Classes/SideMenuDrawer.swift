...
public class SideMenuDrawer: UIView, drawerProtocolNew, UITableViewDelegate, UITableViewDataSource {
    ...
    convenience public init(elements: [DrawerModel], controller:UIViewController) {
        ...
        self.tableView.register(SideMenuDrawerCell.self, forCellReuseIdentifier: "cell")
